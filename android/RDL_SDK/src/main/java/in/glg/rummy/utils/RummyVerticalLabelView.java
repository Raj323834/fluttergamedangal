...
public class RummyVerticalLabelView extends View {
    ...
    public RummyVerticalLabelView(Context context) {
        super(context);
        initLabelView();
    }

    public RummyVerticalLabelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initLabelView();
